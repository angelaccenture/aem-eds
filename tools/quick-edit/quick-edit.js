...
function injectPublishButton() {
  ...
  pageDialog.innerHTML = `
    ...
    <div class="palette-field">
      ...
      <input id="page-title-input" class="palette-input" placeholder="Page title...">
    </div>
    <div class="palette-field">
      <span class="palette-label">Template</span>
      <input id="page-template-input" class="palette-input" placeholder="e.g. Blog, Product...">
    </div>
    <div class="palette-actions">
      <button class="palette-btn-cancel">Cancel</button>
      <button class="palette-btn-ok">OK</button>
  ...
  pageDialog.querySelector('.palette-btn-ok').addEventListener('click', () => {
    const title = pageDialog.querySelector('#page-title-input').value;
    const template = pageDialog.querySelector('#page-template-input').value;
    if (title) document.title = title;
    const metaTitle = document.querySelector('meta[property="og:title"]');
    if (metaTitle && title) metaTitle.content = title;
    const metaTemplate = document.querySelector('meta[name="template"]');
    if (metaTemplate && template) {
      metaTemplate.content = template;
    } else if (template) {
  ...
  pageBtn.addEventListener('click', () => {
    ...
    const titleInput = pageDialog.querySelector('#page-title-input');
    const templateInput = pageDialog.querySelector('#page-template-input');
    titleInput.value = document.title || '';
    const metaTemplate = document.querySelector('meta[name="template"]');
    templateInput.value = metaTemplate ? metaTemplate.content : '';
  ...
  if (previewBtn) {
    previewBtn.after(pageBtn, pagePropsBtn, publishBtn);
  } else {
    buttonsBar.append(pageBtn, pagePropsBtn, publishBtn);
  }
}
